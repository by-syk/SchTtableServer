...
public class CdutMd5 {
    ...
    public static String hex_hmac_md5(String key, String data) {
        return binl2hex(core_hmac_md5(key, data));
    }

    public static String b64_hmac_md5(String key, String data) {
        return binl2b64(core_hmac_md5(key, data));
    }

    public static String str_hmac_md5(String key, String data) {
...
//     */
//    private static boolean md5_vm_test() {
//        return "900150983cd24fb0d6963f7d28e17f72".equals(hex_md5("abc"));
//    }

    /*
     * Calculate the MD5 of an array of little-endian words, and a bit length
     */
    private static int[] core_md5(int[] x2, int len) {
        /* append padding */
        int index_para2 = (((len + 64) >>> 9) << 4) + 14;
        int[] x = new int[index_para2 + 2];
    ...
    private static int[] str2binl(String str) {
        int len = (((str.length() - 1) * chrsz) >> 5) + 1;
        int[] bin = new int[len];
        int mask = (1 << chrsz) - 1;
...
//        System.out.println(md5_vm_test());
//    }
}